...
# brevitas_quant_model = quantized.QTFCInt5(64, 64, 64)  # (98.00%, 97.99%)
# brevitas_quant_model = quantized.QTFCInt4(64, 64, 64)  # ( 97.41%, 97.38%)
...
# brevitas_quant_model = quantized.QTFCFixedPoint4(64, 64, 64)  # (94.52%, 94.48%)
# brevitas_quant_model = quantized.QTFCShiftedQuantAct8(64, 64, 64)  # (98.14%, 98.14%)
brevitas_quant_model = quantized.QTFCShiftedQuantAct4(64, 64, 64)  # (97.49 %, 97.55%)
# ===========================================================================
