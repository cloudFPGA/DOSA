...
from gradatim.backend.buildTools.lib.cFBuild1.cFCreate.templates.gen_env import __cfenv_small_name__, \
    __cfenv_req_packages__, get_sys_python_env
from gradatim.backend.buildTools.lib.cFBuild1.cFCreate.lib.cf_create import create_cfp_dir_structure, \
    __to_be_defined_key__, copy_templates_and_set_env
from gradatim.backend.buildTools.lib.cFBuild1.cFCreate.templates.cf_sratool import __cfp_json_name__, \
...
class cFBuild1(HwBuildTopVhdl):
    ...
    def __init__(self, name, target_device: DosaBaseHw, build_dir=None):
        ...
        self.constr_lines.append(
            'set_false_path -through [get_nets  "*ROLE/piMMIO_Ly7_En*"] -through [get_nets  "*ROLE/piMMIO_Ly7_Rst*"]'
        )
