...
#  *
#  *     Description:
#  *        DOSA OSG to export kernels to Olympus
#  *
#  *
...
def _generate_threshold_block(threshold_op, in_var_name, out_var_name):
    ...
    if fix_threshold_value:
        print(
            f"[OSG:Olympus:INFO] threshold vector contains to large value entries, need to floor "
...
class OlympusOSG(BaseOSG):
    ...
    def build_block(self, arch_block, build_tool, selected_contracts):
        print("[DOSA:Build:ERROR] olympus OSG was asked to build a block out of engine context. STOP.")
        exit(1)

    def _build_compute_block(self, arch_block, build_tool, selected_contracts):
                ...
                if op_c.osg_intern_id[0:5] == 'conf:':
                    ...
                    for c in conf_list:
                        if 'reuse_factor' in c:
                            ...
                            print("[DOSA:olympusOSG:INFO] Using adapting reuse factor by {}.".format(reuse_factor_temp))
        ...
        if np.prod(input_batch_shape) < reuse_factor_stream:
            ...
            print("[DOSA:olympusOSG:INFO] Small input, using reuse_factor {}.".format(reuse_factor_stream))
        ...
        hls_config = {'Model': {
            # 'Precision': precision_string,
            'Precision': precision_dict,
            'ReuseFactor': reuse_factor_stream,
            'Strategy': 'Latency'}}
                ...
                if op_c.osg_intern_id[0:5] == 'conf:':
                    ...
                    for c in conf_list:
                        if 'mult_limit' in c:
                            ...
                            print("[DOSA:olympusOSG:INFO] Using adapted mult_limit_factor {}.".format(mult_limit_factor))
        ...
        print("[DOSA:olympusOSG:INFO] starting hls4ml tool...")
