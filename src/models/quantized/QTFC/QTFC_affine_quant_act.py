...
class QTFCAffineQuantAct(QuantModel):
    """
    Quantization method: uniform, symmetric int8
    """
    def __init__(self, hidden1, hidden2, hidden3):
        super(QTFCAffineQuantAct, self).__init__()
        self.features.append(qnn.QuantIdentity(act_quant=ShiftedUint8ActPerTensorFloat, return_quant_tensor=True))
        ...
        self.features.append(qnn.QuantIdentity(act_quant=ShiftedUint8ActPerTensorFloat,
