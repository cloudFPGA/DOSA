...
#define DOSA_HADDOC_VALID_WAIT_CNT 25
...
#define HADDOC_INPUT_FRAME_BIT_CNT (CNN_INPUT_FRAME_SIZE*DOSA_HADDOC_GENERAL_BITWIDTH)
#define HADDOC_OUTPUT_FRAME_BIT_CNT (CNN_OUTPUT_FRAME_SIZE*DOSA_HADDOC_GENERAL_BITWIDTH)
#define HADDOC_INPUT_FRAME_BYTE_CNT ((HADDOC_INPUT_FRAME_BIT_CNT+7)/8)
#define HADDOC_OUTPUT_FRAME_BYTE_CNT ((HADDOC_OUTPUT_FRAME_BIT_CNT+7)/8)
...
#define HADDOC_AVG_LAYER_LATENCY (DOSA_HADDOC_VALID_WAIT_CNT)
