...
if { $useWrapperTest } {
  add_files   ${srcDir}/hls4ml_wrapper.cpp -cflags "-DWRAPPER_TEST -Wno-attributes"
  add_files   ${srcDir}/hls4ml_wrapper.hpp -cflags "-DWRAPPER_TEST -Wno-attributes"
  add_files -tb tb/tb_hls4ml_wrapper.cpp -cflags "-DWRAPPER_TEST -Wno-attributes"
} else {
  add_files   ${srcDir}/hls4ml_wrapper.cpp -cflags "-Wno-attributes"
  add_files   ${srcDir}/hls4ml_wrapper.hpp -cflags "-Wno-attributes"
  add_files -tb tb/tb_hls4ml_wrapper.cpp -cflags "-Wno-attributes"
}
